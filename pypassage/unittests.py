...
class TestPassageCollection(unittest.TestCase):
    ...
    def test_string(self):
        ...
        self.assertEqual(str(C(P('Eph',1,1),P('Eph',1,3),P('Eph',1,5))), "Ephesians 1 vv. 1, 3, 5")
        self.assertEqual(str(C(P('Eph',1,9),P('Eph',1,3),P('Eph',1,5))), "Ephesians 1 vv. 9, 3, 5")
        self.assertEqual(str(C(P('Eph',1,9),P('Eph',1,13,1,17))), "Ephesians 1 vv. 9, 13-17")
        self.assertEqual(str(C(P('Eph',1,1,1,9),P('Eph',1,15))), "Ephesians 1 vv. 1-9, 15")
        self.assertEqual(str(C(P('Eph',1,1),P('Eph',1,3,1,7),P('Eph',1,15))), "Ephesians 1 vv. 1, 3-7, 15")
        #Different chapters
        ...
        self.assertEqual(str(C(P('Eph',1,1),P('Eph',3),P('Eph',5))), "Ephesians 1:1, chs. 3, 5")
        self.assertEqual(str(C(P('Eph',1),P('Eph',3,5),P('Eph',6))), "Ephesians 1, 3:5, ch. 6")
        self.assertEqual(str(C(P('Eph',1),P('Eph',3,1,3,9),P('Eph',5))), "Ephesians 1, 3:1-9, ch. 5")
        #Different books
        ...
        self.assertEqual(str(C(P('Eph',1),P('Gen',1,1),P('Gen',1,3),P('Gen',1,5),P('Mat',5),P('Mat',9),P('Mat',1))), "Ephesians 1; Genesis 1 vv. 1, 3, 5; Matthew 5, 9, 1")
