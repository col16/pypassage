...
class TestPassageLookup(unittest.TestCase):
	def test_esv(self):
		self.assertEqual(P('Gen',1,1).text(api_key=ESV_API_KEY)[0], '  In the beginning, God created the heavens and the earth.\n\n')
		self.assertEqual(P('Gen',1,1).text(api_key=ESV_API_KEY, options={"include-passage-references":"true"})[0], 'Genesis 1:1\n\n  In the beginning, God created the heavens and the earth.\n\n')
